...
var eye = vec3.create([0.0,0.0,60.0]);
...
window.onload = function init()
{
    ...
    pole = new Cube({"vColor": [0.04,0.04,0.04,1.0]});
    flag = new Cube({"textureSrc":"rezicelandicflag.png"});
    flag.renderVertices = true;
    flag.renderLines = false;
    pole.renderVertices = true;
    var goldenrat = 1.61803398875;
    var rat = 32/18.0;
    var h = 10;
    flag.scale([h*rat,h,0.1]);
    flag.translate(h*rat/2,h*2-h/2-0.1,0);
    pole.scale(0.2,h*4,0.2);
